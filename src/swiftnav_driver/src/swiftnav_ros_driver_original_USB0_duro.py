...
def cb_SBP_MSG_POS_LLH(msg_llh, **source):
    ...
    Publishes the received GPS position in LLH coordinates.

    Args:
        msg_llh: The SBP_MSG_POS_LLH message.
...
def cb_SBP_MSG_BASELINE_NED(msg_ned, **source):
    ...
    Publishes the received baseline in NED coordinates.

    Args:
        msg_ned: The SBP_MSG_BASELINE_NED message.
        source: Additional source information.
...
def cb_SBP_MSG_IMU_RAW(msg_imu_raw, **source):
    ...
    Args:
        msg_imu_raw: The SBP_MSG_IMU_RAW message.
        source: Additional source information.
...
def cb_SBP_MSG_IMU_AUX(msg_imu_aux, **source):
    ...
    Args:
        msg_imu_aux: The SBP_MSG_IMU_AUX message.
        source: Additional source information.
